class AddressController {
    ...
    def ajaxDetail = {
        ...
        render(template:'addressDetail', var:'addressInstance', bean: address)
    }
        ...
        if (addressInstance) {
            if (params.version) {
                ...
                if (addressInstance.version > version) {
                    ...
                    addressInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: 'address.label', default: 'Address')], "Another user has updated this Address while you were editing")
