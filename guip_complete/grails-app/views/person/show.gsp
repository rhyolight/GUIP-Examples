...
<html>
    ...
    <body>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><a id="addressDetailTrigger" href="#">${personInstance?.address?.encodeAsHTML()}</a></td>
        ...
        <gui:dialog id="addressDialog"
            triggers="[show:[on:'click',id:'addressDetailTrigger']]"
        >
            <div id="addressDetails">
                <g:render template="../address/addressDetail" var="addressInstance" bean="${personInstance.address}"/>
            </div>
        </gui:dialog>
    </body>
</html>
